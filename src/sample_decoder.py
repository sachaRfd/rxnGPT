...
if __name__ == "__main__":
    ...
    # Variables:
    ckpt_path = "exp_tree_decoder/large_model_1/epoch_39_val_loss_0.3318_ckpt.pt"

    max_new_tokens = 1_360
    temperature = 1.0
    ...
    path_to_save_samples = os.path.join(
        path_to_save, "predicted-tgt-epoch-epoch-testing123.txt"
    )
    ...
    test_path = "data/one_to_infinite_step_with_reaction_classes_fixed"
