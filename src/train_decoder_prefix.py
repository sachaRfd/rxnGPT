...
def main():
    ...
    name = "prefixLM_MIT_mixed_test_continued"

    out_dir = f"exp_prefixLM/{name}"
    trained_model_path = "exp_prefixLM/prefixLM_MIT_mixed_test/epoch_9_val_loss_0.0663_ckpt.pt"  # "exp_MIT_decoder/decoder_testing_bidirectional_src_mask/epoch_9_val_loss_0.0552_ckpt.pt"  # (
    ...
    wandb_project = "prefixLM_MIT_mixed "

    wandb_run_name = f"decoder_{name}"  # 'run' + str(time.time())

    # Dataset params:
    block_size = 560  # 560  # 1024 + 512  # 560  # 911  # 560
    batch_size = 64  # 64  # 8  # 32  # 64 * 4  # 6
    epochs = 10
